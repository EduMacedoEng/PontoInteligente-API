...
import com.eduardo.pontointeligente.api.Enums.TipoEnum;
...
public class Lancamento implements Serializable {
	...
	public String toString() {
		return "Lancamento [id: " +id+ "data: " +data+ "descricao: " +descricao+ "localizacao" +localizacao+ "dataCriacao" +dataCriacao+ 
